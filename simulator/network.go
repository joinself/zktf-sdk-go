...
import "github.com/joinself/zktf-sdk-go/internal/simffi"
...
func NewNetwork(apiPort, objectPort, messagingPort, controlPort uint16) *Network {
	return &Network{h: simffi.NewNetwork(apiPort, objectPort, messagingPort, controlPort)}
}

// NewDefaultNetwork starts a simulated network on the default ports
// (3000/3500/4000/9000).
func NewDefaultNetwork() *Network {
	return &Network{h: simffi.NewDefaultNetwork()}
}
